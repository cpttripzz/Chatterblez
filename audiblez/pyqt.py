...
class CoreThread(QThread):
    ...
    progress = pyqtSignal(object)  # SimpleNamespace from core
    ...
    # The bridge that core.main will call
...
class MainWindow(QMainWindow):
    def __init__(self, parent, title):
        ...
        # Load persistent settings for wav and output folder
    ...
    #     try:
    #         self.selected_speed = float(value)
    #     except ValueError:
...
def main():
    ...
    win = MainWindow(None, "Audiblez – Audiobook Generator (PyQt6)")
    win.show()
    sys.exit(app.exec())
